    ...
    <body>
        ...
        <div class="detail" id="detail">
            <div class="image-content">
                <img src="/image/resep 2.png" alt="">
            </div>
            <div class="text-head">
                <h3>Soupe à l'oignon gratinée</h3>
                <div class="text-wrapper">by Marie Julie Grandjean Mouquin</div>
                <div class="info-container text-white">
                    <div class="tengah">
                        <div class="text-time ">
                            <h5><img src="/image/time.png" style="margin-right: 20px;">2 Jam</h5>
                            <h5 style="margin-left: 20px; margin-right: 20px;">|</h5>
                            <h5><img src="/image/porsi.png" style="margin-left: 10px; margin-right: 20px;">4 Porsi</h5>
                        </div>
                        <div class="kesulitan">
                            <h5><img src="/image/hat.png" style="margin-right: 20px;" alt="">Tingkat Kesulitan: Sulit</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-body">
            ...
            <p>Bawang kuning adalah taruhan serba guna terbaik Anda untuk sup ini, tetapi campuran bawang kuning, manis (mis., Vidalia), dan bawang merah, serta bawang merah, menghasilkan rasa yang lebih kompleks.</p>
        </div>
        <div class="content-item">
            ...
            <div class="image-item">
                <h1>Gambar</h1>
                <img src="/image/soup 1.png" alt="">
                <img src="/image/soup 2.png" alt="">
                <img src="/image/soup 3.png" alt="">
                <img src="/image/soup 4.png" alt="">
            </div>
        </div>        
        @include('nav.footer')
    </body>
