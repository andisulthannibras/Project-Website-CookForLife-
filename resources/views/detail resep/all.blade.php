    ...
    <body>
        ...
        <div class="detail" id="detail">
            <div class="image-content">
                <img src="{{asset($resep->image)}}" alt="">
            </div>            
            <div class="text-head">
                <h3>{{$resep->nama}}</h3>
                <div class="text-wrapper">{{$resep->pencipta}}</div>
                <div class="info-container text-white">
                    <div class="tengah">
                        <div class="text-time ">
                            <h5><img src="/image/time.png" style="margin-right: 20px;">{{$resep->durasi}}</h5>
                            <h5 style="margin-left: 20px; margin-right: 20px;">|</h5>
                            <h5><img src="/image/porsi.png" style="margin-left: 10px; margin-right: 20px;">{{$resep->porsi}}</h5>
                        </div>
                        <div class="kesulitan">
                            <h5><img src="/image/hat.png" style="margin-right: 20px;" alt="">{{$resep->tingkat_kesulitan}}</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-body">
            ...
            <p style="margin-bottom: 130px; margin-top:30px">{{$resep->catatan}}</p>
        </div>
        <div class="content-item">
            ...
            <div class="image-item">
                <h1>Gambar</h1>
                <img src="{{asset($resep->image_1)}}" alt="">
                <img src="{{asset($resep->image_2)}}" alt="">
                <img src="{{asset($resep->image_3)}}" alt="">
                <img src="{{asset($resep->image_4)}}" alt="">
            </div>
        </div>        
        @endif
        @include('nav.footer')
